...
import horizontalBanner from "@/assets/banner-trading.jpg"
    ...
    return (
        <div className="relative min-h-screen bg-neutral-900 text-white flex items-center justify-center overflow-hidden px-6">
            <motion.img
                ...
                className="absolute inset-0 w-full h-full object-cover opacity-20 blur-none z-0"
            />
            ...
            >
                ...
                <p className="text-neutral-300 text-sm mb-8">
                    Gracias por tu compra. Te hemos enviado toda la información
                    del curso a su correo.
                </p>
                ...
                {isLoading ? (
                    ...
                    <motion.button
                        ...
                        className="inline-block cursor-pointer border border-green-500 hover:bg-green-400 text-slate-200 text-sm font-semibold py-2 px-5 rounded-xl transition-all duration-300 ease-in-out shadow-md hover:shadow-[0_4px_6px_rgba(0,0,0,0.4)]"
                    >
                        Volver al inicio
                    </motion.button>
                )}
